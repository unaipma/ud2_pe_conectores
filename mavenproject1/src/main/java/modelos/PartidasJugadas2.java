...
public class PartidasJugadas2 {
    ...
    // Constructor
    public PartidasJugadas2(String gameId, String playerId, int experience, int lifeLevel, int coins, Date sessionDate) {
        this.gameId = gameId;
...
//    public static List<PartidasJugadas2> cargarPartidas(String archivo) {
//        List<PartidasJugadas2> partidas = new ArrayList<>();
...
//
//                partidas.add(new PartidasJugadas2(gameId, playerId, experience, lifeLevel, coins, sessionDate));
//            }
